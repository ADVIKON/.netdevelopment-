    ...
    public class EuforyServices : IEuforyServices
    {
        ...
        public List<ResponceSplSplaylistTitle> GetSplPlaylistTitles(DataSplPlaylistTile data)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                {
                    ...
                    url = "http://api.nusign.eu/mp3files/" + ds.Tables[0].Rows[i]["titleId"].ToString() + mtypeFormat;
            ...
            try
            {
                ...
                for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                {
                    result.Add(new ResponceCustomerContent()
                    {
                        ...
                        AlbumID = Convert.ToInt32(ds.Tables[0].Rows[i]["AlbumID"]),
                        alName = ds.Tables[0].Rows[i]["alName"].ToString(),
                        TitleUrl = "http://api.nusign.eu/mp3files/" + ds.Tables[0].Rows[i]["titleId"].ToString() + mtypeFormat,
        ...
        public List<ResPlaylistSongList> PlaylistSong(ReqPlaylistSongList data)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < ds.Rows.Count; i++)
                {
                    ...
                    url = "http://api.nusign.eu/mp3files/" + ds.Rows[i]["titleId"].ToString() + mtypeFormat;
        ...
        public List<ResSongList> CommanSearch(ReqCommonSearch data)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < ds.Rows.Count; i++)
                {
                    ...
                    url = "http://api.nusign.eu/mp3files/" + ds.Rows[i]["titleId"].ToString() + format;
        ...
        public ResResponce SaveAdsAndUploadFile()
        {
            ...
            try
            {
                ...
                if (objs.type.ToString() == "Video")
                {
                    ...
                    cmd.Parameters["@AdvtFilePath"].Value = "http://api.nusign.eu/AdvtSongs/" + ReturnAdvtId + ".mp4";
                }
                else if (objs.type.ToString() == "Picture")
                {
                    cmd.Parameters.Add(new SqlParameter("@AdvtFilePath", SqlDbType.VarChar));
                    cmd.Parameters["@AdvtFilePath"].Value = "http://api.nusign.eu/AdvtSongs/" + ReturnAdvtId + ".jpg";
                }
                else
                {
                    cmd.Parameters.Add(new SqlParameter("@AdvtFilePath", SqlDbType.VarChar));
                    cmd.Parameters["@AdvtFilePath"].Value = "http://api.nusign.eu/AdvtSongs/" + ReturnAdvtId + ".mp3";
                }
        ...
        public ResResponce SendMail(ReqTokenInfo data)
        {
            ...
            try
            {
                ...
                body += "\n";
                body += "The player download links are available on our website www.nusign.eu under the Links menu. \n";
                body += "\n";
                body += "Best Regards \n";
                body += "Your Support Team";
                body += "\n";
                body += "\n";
                body += "Note: Please Unzip the Windows player file after download in the administration location. Then click on the player exe for the activation of your license adding tour customer name with country code and the token you use for the selected player.";
                body += "\n";
        ...
        public ResResponce UploadStreamImage()
        {
            ...
            try
            {
                ...
                cmd.Parameters["@dfclientid"].Value = CustomerId;
                cmd.Parameters.Add(new SqlParameter("@ImgPath", SqlDbType.NVarChar));
                cmd.Parameters["@ImgPath"].Value = "http://api.nusign.eu/AppStreamPic/" + fName;
                cmd.ExecuteNonQuery();
            ...
            try
            {
                ...
                for (int i = 0; i < ds.Rows.Count; i++)
                {
                    lstResult.Add(new ResFillMiddleImage()
                    {
                        ...
                        TitleIdLink = "http://api.nusign.eu/mp3files/" + ds.Rows[i]["TitleID"].ToString() + ".jpg"
        ...
        public ResResponce SetMiddleImg(ReqSetMiddleImg data)
        {
            ...
            try
            {
                var url = "http://api.nusign.eu/mp3files/" + data.TitleId.ToString() + ".jpg";
                SqlCommand cmd = new SqlCommand();
                cmd.Connection = con;
